...
func (eu *EmployeeUsecase) GetMe(proposerId string) (*domain.Employee, error) {
	// cek proposer
	proposer, err := eu.empRepo.FindByID(proposerId)
	if err != nil {
		return nil, &utils.NotFoundError{Message: "user not found"}
...
func (eu *EmployeeUsecase) UpdateMe(proposerId string, employee *domain.Employee) (*domain.Employee, error) {
	// cek proposer
	proposer, err := eu.empRepo.FindByID(proposerId)
	if err != nil || proposer == nil {
		return nil, &utils.NotFoundError{Message: "user not found"}
...
func (eu *EmployeeUsecase) UploadPPMe(proposerId string, file *multipart.FileHeader) (string, error) {
	// cek proposer
	proposer, err := eu.empRepo.FindByID(proposerId)
	if err != nil {
		return "", &utils.NotFoundError{Message: "user not found"}
